      ...
      <div className="h-screen flex flex-col bg-gray-50 relative">
        <nav className="bg-white shadow-sm px-6 py-3 flex justify-between items-center z-[50] relative">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={handleLogout} className="text-sm bg-gray-100 text-gray-700 px-3 py-2 rounded-md hover:bg-gray-200 flex items-center gap-1"><LogOut size={16}/> 로그아웃</button>
          </div>
        </nav>
        ...
        <div className="absolute bottom-10 left-0 right-0 flex justify-center gap-3 z-[100] pointer-events-none">
          <div className="pointer-events-auto">
            {userProfile?.role === 'hospital' ? (
              <button onClick={() => setShowJobModal(true)} className="bg-blue-600 text-white px-6 py-3 rounded-full shadow-2xl font-bold hover:bg-blue-700 flex items-center gap-2 cursor-pointer border-2 border-white transform hover:scale-105 transition-all">
                <Plus size={20}/> 채용 공고 올리기
              </button>
            ) : (
              <button onClick={() => setShowProfileModal(true)} className="bg-purple-800 text-white px-6 py-3 rounded-full shadow-2xl font-bold hover:bg-purple-900 flex items-center gap-2 border-2 border-white transform hover:scale-105 transition-all">
